    ...
    <div class="table-responsive">
      <table class="table table-striped table-hover align-middle mb-0">
        ...
        <tr>
          ...
          <th class="text-end no-print">Дії</th> </tr>
        </thead>
        <tbody>
          ...
          <tr>
            ...
            <td class="text-end no-print">
              ...
              <c:when test="${sessionScope.userRole == 'Менеджер'}">
                <a href="products?action=edit&id=${prod.id_product}" class="btn btn-sm btn-outline-warning me-1" title="Edit">
                  <i class="bi bi-pencil"></i>
                </a>
                <a href="products?action=delete&id=${prod.id_product}" class="btn btn-sm btn-outline-danger" onclick="return confirm('Delete the product?')" title="Delete">
                  <i class="bi bi-trash"></i>
                </a>
              </c:when>
              <c:otherwise>
              <button class="btn btn-sm btn-outline-secondary" disabled title="Not authorised to edit">
