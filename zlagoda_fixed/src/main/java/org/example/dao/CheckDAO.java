...
public class CheckDAO {
     ...
     * @param dateTo           кінець діапазону (включно), або null
     */
    ...
    /**
     * Створення чеку з позиціями продажу в одній транзакції.
     * Також знижує кількість на складі.
     */
        ...
        try {
            ...
            try (PreparedStatement saleStmt  = conn.prepareStatement(saleSql);
                ...
                for (Sale sale : sales) {
                    ...
                    // Перевіряємо, що достатньо товару в наявності
