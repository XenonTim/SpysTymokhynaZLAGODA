...
<div class="container-fluid">
  ...
  <%-- Фільтри — менеджер може фільтрувати по касиру та датах. --%>
  <div class="card shadow-sm border-0 mb-4 no-print bg-light">
    <div class="card-body py-3">
      <form action="checks" method="GET" class="row g-3 align-items-end">
        ...
        <%-- Фільтр по касиру — тільки менеджер. --%>
        <c:if test="${sessionScope.userRole == 'Manager'}">
          <div class="col-md-3">
          ...
          <div class="col-md-2">
            <label class="form-label small text-muted">Date tо</label>
          ...
          <c:forEach var="ch" items="${checks}">
            <tr>
              ...
              <td class="text-end no-print">
                <%-- Перегляд деталей доступний всім. --%>
