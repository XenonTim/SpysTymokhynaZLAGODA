...
<div class="container-fluid">
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <button onclick="openPrintPreview('Categories', 'report-table')" class="btn btn-outline-secondary d-flex align-items-center no-print">
        ...
        <div class="col-md-4">
          <div class="input-group">
            ...
            <select name="sortBy" class="form-select" id="sortSelect" onchange="this.form.submit()">
              ...
              <option value="number">By ID</option>
            </select>
          </div>
        </div>
